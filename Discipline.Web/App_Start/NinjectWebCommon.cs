[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Discipline.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Discipline.Web.App_Start.NinjectWebCommon), "Stop")]

namespace Discipline.Web.App_Start {
    using System;
    using System.Web;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void AddBindings(StandardKernel kernel) {
            ...
            // Domain
            kernel.Bind<AbstractDbContext>().To<ApplicationDbContext>().InRequestScope();

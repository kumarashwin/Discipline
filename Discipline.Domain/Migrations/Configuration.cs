namespace Discipline.Domain.Migrations {
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Discipline.Domain.Concrete.ApplicationDbContext> {
        public Configuration() {
            AutomaticMigrationsEnabled = false;
        }

        protected override void Seed(Discipline.Domain.Concrete.ApplicationDbContext context) {
        ...
        private Dictionary<string, int> GetIdOfAllActivities(Discipline.Domain.Concrete.ApplicationDbContext context) =>
